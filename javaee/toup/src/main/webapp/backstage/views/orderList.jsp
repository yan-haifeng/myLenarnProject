...
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
  <legend>订单管理</legend>
	...
	<form id="orderDataList" action="" method="" class="layui-form">
		<button class="layui-btn" style="margin-left:20px;" id="sub" lay-submit="" lay-filter="sub">保存</button><a href="${pageContext.request.contextPath }/backstage/views/orderAdd.jsp" class="layui-btn">添加</a>
        <div id="Gl_Table">
	...
	$(function(){
		$.ajax({
			...
			,success : function(result){
				orderViewDataList=result.data;
				//orderViewDataList=JSON.stringify(result);
				console.log("orderViewDataList: "+JSON.stringify(orderViewDataList));
				table.render({
				    elem: '#dataTable'
				    ,id:'lDataTable'
				    ,height:400
